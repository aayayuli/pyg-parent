...
购热销商品</em>
                    ...
                    <#--[{"text":"内存大小","value":"最大支持512G"},{"text":"颜色","value":"五颜六色任君选择"}]-->
                   ...
                   <#-- [{"attributeValue":["移动4G","联通4G","电信4G","双卡"],"attributeName":"网络"},
					{"attributeValue":["64G","128G"],"attributeName":"机身内存"},
					{"attributeValue":["5.5寸"],"attributeName":"手机屏幕尺寸"}]-->
						...
						<div id="specification" class="summary-wrap clearfix">
							<#list specificationItems as spec>
								<dl>
									...
									<#--class="selected"-->
									 <dd ng-click="updateSpec('${spec.attributeName}', '${value}')"><a href="javascript:;" class="{{isSelected('${spec.attributeName}', '${value}')?'selected':''}}"     >${value}<span title="点击取消选择">&nbsp;</span></a></dd>
									</#list>
								</dl>
							</#list>
						</div>
